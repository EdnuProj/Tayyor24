...
import { Send, Loader2, Image as ImageIcon, Upload, X, Users } from "lucide-react";
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Masalan: Yangi mahsulotlar keldi" {...field} data-testid="input-title" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
